...
save_graph_diagnostic_image( env, policy, num_env_steps, 2,"Initial sample paths" , "./tests/figs/initial_sample_paths.png")
save_grid_diagnostic_image(env, policy, num_env_steps, 2, "Initial sample paths", "./tests/figs/initial_sample_paths_grid.png")
...
plt.savefig("./tests/figs/avg_successes.png")
plt.close('all')
...
plt.savefig("./tests/figs/avg_rewards.png")
plt.close('all')
...
save_graph_diagnostic_image(env, policy, num_env_steps, 2, "After PG", "./tests/figs/after_pg.png")
save_grid_diagnostic_image(env, policy, num_env_steps, 2, "After PG", "./tests/figs/after_pg_grid.png")
...
plt.ylabel("Avg Successs")
plt.plot((np.arange(num_pg_steps) + 1)*trajectory_batch_size,  training_success_evolution, label = "avg successes", linewidth = 3.5, color = "red")
plt.savefig("./tests/figs/avg_successes_P.png")
plt.close('all')
...
plt.ylabel("Avg Reward")
plt.plot((np.arange(num_pg_steps) + 1)*trajectory_batch_size,  training_reward_evolution, label = "avg rewards", linewidth = 3.5, color = "red")
plt.savefig("./tests/figs/avg_rewards_P.png")
plt.close('all')
...
save_graph_diagnostic_image(env, policy, num_env_steps, 2, "P change", "./tests/figs/after_P_change.png")
save_grid_diagnostic_image(env, policy, num_env_steps, 2, "P change", "./tests/figs/after_P_change_grid.png")
