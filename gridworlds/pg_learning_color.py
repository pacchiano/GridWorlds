...
def learn_color_pg(env, color_policy, num_pg_steps, trajectory_batch_size, num_env_steps, multifood = False, verbose = False, supress_training_curve = True, logging_frequency = None, reset_env = True):
